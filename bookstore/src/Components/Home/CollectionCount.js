...
export default class CollectionCount extends Component {
    render() {
        return (
            <section className="tg-parallax tg-bgcollectioncount tg-haslayout" data-z-index={-100} data-appear-top-offset={600} data-parallax="scroll" data-image-src="./assets/images/parallax/bgparallax-04.png">
