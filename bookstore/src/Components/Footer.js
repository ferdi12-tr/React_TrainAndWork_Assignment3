            ...
            <footer id="tg-footer" className="tg-footer tg-haslayout">
                            ...
                            <div className="tg-threecolumns">
                                <div className="col-xs-12 col-sm-6 col-md-4 col-lg-4">
                                    <div className="tg-footercol">
                                        <strong className="tg-logo"><a href=""><img src="./assets/images/flogo.png" alt="" /></a></strong>
                                ...
                                <div className="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                                    <div className="tg-footercol tg-widget tg-widgettopsellingauthors">
                                        ...
                                        <div className="tg-widgetcontent">
                                            <ul>
                                                <li>
                                                    <figure><a href=""><img src="./assets/images/author/imag-09.jpg" alt="" /></a></figure>
                                                    <div className="tg-authornamebooks">
                                                        <h4><a href="">Jude Morphew</a></h4>
                                                        <p>21,658 Published Books</p>
                                                    </div>
                                                </li>
                                                <li>
                                                    <figure><a href=""><img src="./assets/images/author/imag-10.jpg" alt="" /></a></figure>
                                                    <div className="tg-authornamebooks">
                                                        <h4><a href="">Shaun Humes</a></h4>
                                                        <p>20,257 Published Books</p>
                                                    </div>
                                                </li>
                                                <li>
                                                    <figure><a href=""><img src="./assets/images/author/imag-11.jpg" alt="" /></a></figure>
                                                    <div className="tg-authornamebooks">
                                                        <h4><a href="">Kathrine Culbertson</a></h4>
                ...
                <div className="tg-footerbar">
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <span className="tg-paymenttype"><img src="./assets/images/paymenticon.png" alt="" /></span>
